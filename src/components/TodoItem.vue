<template>
  <div
    class="flex items-center justify-between bg-white p-4 rounded-lg shadow-lg transition-transform transform hover:scale-y-105">
    <div class="flex-1">
      ...
      <template v-else>
        <span @dblclick="enableEdit" :class="{ 'line-through text-gray-500': todo.completed }"
